 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(A){function e(H,S){var M=H.length;H.push(S);A:for(;0<M;){var j=M-1>>>1,z=H[j];if(0<n(z,S))H[j]=S,H[M]=z,M=j;else break A}}function t(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var S=H[0],M=H.pop();if(M!==S){H[0]=M;A:for(var j=0,z=H.length,lA=z>>>1;j<lA;){var BA=2*(j+1)-1,CA=H[BA],oA=BA+1,EA=H[oA];if(0>n(CA,M))oA<z&&0>n(EA,CA)?(H[j]=EA,H[oA]=M,j=oA):(H[j]=CA,H[BA]=M,j=BA);else if(oA<z&&0>n(EA,M))H[j]=EA,H[oA]=M,j=oA;else break A}}return S}function n(H,S){var M=H.sortIndex-S.sortIndex;return M!==0?M:H.id-S.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;A.unstable_now=function(){return i.now()}}else{var o=Date,a=o.now();A.unstable_now=function(){return o.now()-a}}var s=[],l=[],c=1,u=null,d=3,p=!1,C=!1,v=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(H){for(var S=t(l);S!==null;){if(S.callback===null)r(l);else if(S.startTime<=H)r(l),S.sortIndex=S.expirationTime,e(s,S);else break;S=t(l)}}function Q(H){if(v=!1,h(H),!C)if(t(s)!==null)C=!0,D(U);else{var S=t(l);S!==null&&K(Q,S.startTime-H)}}function U(H,S){C=!1,v&&(v=!1,g(x),x=-1),p=!0;var M=d;try{for(h(S),u=t(s);u!==null&&(!(u.expirationTime>S)||H&&!G());){var j=u.callback;if(typeof j=="function"){u.callback=null,d=u.priorityLevel;var z=j(u.expirationTime<=S);S=A.unstable_now(),typeof z=="function"?u.callback=z:u===t(s)&&r(s),h(S)}else r(s);u=t(s)}if(u!==null)var lA=!0;else{var BA=t(l);BA!==null&&K(Q,BA.startTime-S),lA=!1}return lA}finally{u=null,d=M,p=!1}}var w=!1,y=null,x=-1,L=5,I=-1;function G(){return!(A.unstable_now()-I<L)}function W(){if(y!==null){var H=A.unstable_now();I=H;var S=!0;try{S=y(!0,H)}finally{S?Z():(w=!1,y=null)}}else w=!1}var Z;if(typeof f=="function")Z=function(){f(W)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,GA=q.port2;q.port1.onmessage=W,Z=function(){GA.postMessage(null)}}else Z=function(){E(W,0)};function D(H){y=H,w||(w=!0,Z())}function K(H,S){x=E(function(){H(A.unstable_now())},S)}A.unstable_IdlePriority=5,A.unstable_ImmediatePriority=1,A.unstable_LowPriority=4,A.unstable_NormalPriority=3,A.unstable_Profiling=null,A.unstable_UserBlockingPriority=2,A.unstable_cancelCallback=function(H){H.callback=null},A.unstable_continueExecution=function(){C||p||(C=!0,D(U))},A.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<H?Math.floor(1e3/H):5},A.unstable_getCurrentPriorityLevel=function(){return d},A.unstable_getFirstCallbackNode=function(){return t(s)},A.unstable_next=function(H){switch(d){case 1:case 2:case 3:var S=3;break;default:S=d}var M=d;d=S;try{return H()}finally{d=M}},A.unstable_pauseExecution=function(){},A.unstable_requestPaint=function(){},A.unstable_runWithPriority=function(H,S){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var M=d;d=H;try{return S()}finally{d=M}},A.unstable_scheduleCallback=function(H,S,M){var j=A.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?j+M:j):M=j,H){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=M+z,H={id:c++,callback:S,priorityLevel:H,startTime:M,expirationTime:z,sortIndex:-1},M>j?(H.sortIndex=M,e(l,H),t(s)===null&&H===t(l)&&(v?(g(x),x=-1):v=!0,K(Q,M-j))):(H.sortIndex=z,e(s,H),C||p||(C=!0,D(U))),H},A.unstable_shouldYield=G,A.unstable_wrapCallback=function(H){var S=d;return function(){var M=d;d=S;try{return H.apply(this,arguments)}finally{d=M}}}})(B4);h4.exports=B4;var Gh=h4.exports;/**
 * @license React
...
`])));var Ud,cn=function(A){var e=A.text,t=A.subText,r=A.icon,n=A.width,i=A.height,o=A.justify,a=o===void 0?"center":o,s=A.type,l=s===void 0?"border":s,c=A.status,u=c===void 0?"default":c,d=A.disabled,p=A.pop,C=A.PopProps,v=A.href,E=A.target,g=E===void 0?"_blank":E,f=A.onClick,h=A.children,Q=A.style,U=A.className,w=U===void 0?"":U,y=k.useMemo(function(){if(r){if(!e&&!t)return!0}else return!1},[r,e,t]),x=k.useMemo(function(){switch(u){case"success":return"var(--color-green-";case"warning":return"var(--color-orange-";case"danger":return"var(--color-red-";case"primary":return"var(--color-primary-";default:return""}},[u]);return B(Ri,{children:v?O(q8,F({href:v,target:g,className:"land-button ".concat(l," ").concat(u," ").concat(y?"iconOnly":""," ").concat(d?"disabled":""," ").concat(p?"hover-pop":""," ").concat(w),style:Q,width:n,height:i,justify:a,color:x,onClick:function(L){return f==null?void 0:f(L)}},{children:[h,r,!y&&O("div",{children:[B("span",{children:e}),B("span",F({className:"subText"},{children:t}))]}),p&&B(wt,F({content:p},C))]})):O(R5,F({className:"land-button ".concat(l," ").concat(u," ").concat(y?"iconOnly":""," ").concat(d?"disabled":""," ").concat(p?"hover-pop":""," ").concat(w),style:Q,width:n,height:i,justify:a,color:x,onClick:function(L){return f==null?void 0:f(L)}},{children:[h,r,!y&&O("div",{children:[B("span",{children:e}),t&&B("span",F({className:"subText"},{children:t}))]}),p&&B(wt,F({content:p},C))]}))})},R5=N.div(xd||(xd=R([`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: `,`;
...
`],[`
  ...
  min-height: `,`;
  background: var(--color-bg-white);
`])),function(A){return"calc(100vh - ".concat(A.$minHeight,"px)")}),Td,Nd=function(A){var e=A.value,t=e===void 0?"":e,r=A.size,n=A.border,i=n===void 0?!1:n,o=A.useSelect,a=o===void 0?!0:o,s=A.onChange,l=A.onClick,c=A.style,u=A.className,d=u===void 0?"":u,p=ce(k.useState(t),2),C=p[0],v=p[1];return k.useEffect(function(){return v(t)},[t]),B(oC,F({className:d,style:F(r?{width:typeof r=="number"?"".concat(r,"px"):r,height:typeof r=="number"?"".concat(r,"px"):r,background:C}:{background:C},c),onClick:function(){return l==null?void 0:l(C)},border:i},{children:a&&B("input",{type:"color",onChange:function(E){return s==null?void 0:s(E.target.value,E)}})}))},oC=N.label(Vd||(Vd=R([`
  border: `,`;
  input {
    width: 0px;
    height: 0px;
...
`])));var Od,j5=function(A){var e=A.direction,t=e===void 0?"row":e,r=A.size,n=r===void 0?1:r,i=A.lang,o=i===void 0?"100%":i,a=A.margin,s=a===void 0?0:a,l=A.type,c=l===void 0?"solid":l,u=A.color,d=u===void 0?"var(--color-border-2)":u,p=A.content,C=A.align,v=C===void 0?"center":C,E=A.style,g=A.className,f=g===void 0?"":g;return O(aC,F({className:"land-divider ".concat(f),style:F({width:t==="row"?"".concat(o):"".concat(n,"px"),height:t==="column"?"".concat(o):"".concat(n,"px"),margin:t==="row"?"".concat(s,"px 0"):"0 ".concat(s,"px")},E),direction:t,gap:p?"8px":""},{children:[B("div",{style:{flex:v==="left"?"10%":v==="right"?"90%":1,height:"0px",borderBottom:t==="row"?"".concat(n,"px ").concat(c," ").concat(d):"none",borderLeft:t==="column"?"".concat(n,"px ").concat(c," ").concat(d):"none"}}),p&&O(Ri,{children:[B("div",F({style:{fontSize:"12px",color:"#999",writingMode:t==="column"?"vertical-rl":"unset",textOrientation:t==="column"?"upright":"unset"}},{children:p})),B("div",{style:{flex:v==="left"?"90%":v==="right"?"10%":1,height:"0px",borderBottom:t==="row"?"".concat(n,"px ").concat(c," ").concat(d):"none",borderLeft:t==="column"?"".concat(n,"px ").concat(c," ").concat(d):"none"}})]})]}))},aC=N.div(Rd||(Rd=R([`
  display: flex;
  flex-direction: `,`;
  align-items: center;
  gap: `,`;
...
`])));var jd,Pd,zd,Gd,YA=function(A){var e=A.w,t=e===void 0?"100%":e,r=A.h,n=A.column,i=A.wrap,o=A.justify,a=o===void 0?"start":o,s=A.align,l=s===void 0?"start":s,c=A.gap,u=A.bothCenter,d=A.children,p=A.style,C=A.className,v=C===void 0?"":C;return B(sC,F({className:v,style:p,width:t,height:r,direction:n?"column":"row",gap:typeof c=="number"?"".concat(c,"px"):c,wrap:i,justify:u?"center":a,align:u?"center":l},{children:d}))},sC=N.div(Zd||(Zd=R([`
  display: flex;
  flex-direction: `,`;
  align-items: center;
  gap: `,`;
...
`])),function(A){return A.column?"0":"50%"},function(A){return A.column?"50%":"0"},function(A){return A.column?"2px":"12px"},function(A){return A.column?A.theme.activeBg?"100%":"calc(100% - 16px)":"2px"},function(A){return A.column?"translateY(50%)":"translateX(50%)"},function(A){return A.theme.lineColor||"var(--color-text-1)"},function(A){return A.theme.hoverColor},function(A){return A.theme.hoverBg},function(A){return A.theme.hoverColor},function(A){return A.theme.hoverColor},function(A){return A.theme.activeBg},function(A){return A.theme.activeColor||"var(--color-text-1)"}),Xd,Jd,uC=function(A){var e,t=A.h,r=t===void 0?"64px":t,n=A.fixed,i=A.filter,o=i===void 0?0:i,a=A.borderBottom,s=a===void 0?!0:a,l=A.applications,c=A.logo,u=A.name,d=A.onLogoClick,p=A.divider,C=p===void 0?!0:p,v=A.align,E=A.menuProps,g=A.rightComponent,f=A.style,h=A.className,Q=h===void 0?"":h,U=ce(k.useState(!1),2),w=U[0],y=U[1];return k.useEffect(function(){window.onscroll=function(){return y(!1)},window.onresize=function(){return y(!1)}}),O(dC,F({className:"land-header ".concat(n?"fixed":""," ").concat(Q),style:f,height:r,filter:o,borderBottom:s,applications:!!l},{children:[O("div",F({className:"land-header-logo",onClick:d},{children:[l&&O("button",F({className:"land-header-application",onClick:function(x){return x.stopPropagation()}},{children:[B(xA,{name:"application"}),B("div",F({className:"land-application-drop"},{children:l}))]})),typeof c=="string"?B("img",{src:c}):c,C&&c&&u&&B(j5,{direction:"column",lang:"24px"}),typeof u=="string"?B("img",{src:u}):u]})),B(fC,F({className:"land-header-nav",align:v,showMobileNav:w},{children:E&&B(Mu,F({border:!1},E,{onChange:function(x){var L;(L=E.onChange)===null||L===void 0||L.call(E,x),y(!1)},onDropChange:function(x,L){var I;(I=E.onDropChange)===null||I===void 0||I.call(E,x,L),y(!1)}}))})),g&&B("div",F({className:"land-header-btns"},{children:g})),E&&E.data&&((e=E.data)===null||e===void 0?void 0:e.length)>0&&B(cn,{icon:B(xA,{name:"more-line"}),type:"text",onClick:function(){return y(!w)}})]}))},dC=N.header(Yd||(Yd=R([`
  display: flex;
  align-items: center;
...
`])),function(A){return"".concat(A.size,"px")},function(A){return"".concat(A.size,"px")},function(A){return`radial-gradient(
      ...
      transparent 99%,
      #000 100%
    )`)},function(A){return"conic-gradient(transparent 25%, ".concat(A.color,")")}),Af,z5=function(A){var e=A.type,t=e===void 0?"border":e,r=A.value,n=A.inputType,i=n===void 0?"text":n,o=A.placeholder,a=o===void 0?"请输入":o,s=A.prefix,l=A.useSearch,c=l===void 0?!1:l,u=A.width,d=A.maxLength,p=A.showClear,C=p===void 0?!0:p,v=A.disabled,E=A.onChange,g=A.onFocus,f=A.className,h=A.wrapStyle,Q=Hu(A,["type","value","inputType","placeholder","prefix","useSearch","width","maxLength","showClear","disabled","onChange","onFocus","className","wrapStyle"]),U=ce(k.useState(r),2),w=U[0],y=U[1];return k.useEffect(function(){return y(r)},[r]),O(pC,F({className:"land-input ".concat(v?"disabled":""," ").concat(t," ").concat(f),style:F({width:typeof u=="number"?"".concat(u,"px"):u},h)},{children:[c&&B(xA,{name:"search",stroke:"var(--color-text-5)"}),s&&B("p",F({className:"input-prefix"},{children:s})),B("input",F({placeholder:a,type:i,value:w,max:d,onClick:function(x){return x.stopPropagation()},onFocus:function(x){x.stopPropagation(),g==null||g(x)},onChange:function(x){x.stopPropagation(),E==null||E(x.target.value,x)}},Q)),!!w&&C&&B(xA,{name:"error-fill",className:"land-input-clear-icon",fill:"var(--color-text-5)",onClick:function(){return y("")}})]}))},pC=N.div(ef||(ef=R([`
  display: flex;
  align-items: center;
  gap: var(--gap-4);
  padding: 0 12px;
...
`]))),af,ec=function(A){var e=A.value,t=A.type,r=t===void 0?"border":t,n=A.step,i=n===void 0?1:n,o=A.min,a=o===void 0?0:o,s=A.max,l=s===void 0?100:s,c=A.suffix,u=A.disabled,d=A.onChange;A.className;var p=A.style,C=Hu(A,["value","type","step","min","max","suffix","disabled","onChange","className","style"]),v=ce(k.useState(e),2),E=v[0],g=v[1],f=function(h,Q){Q<a-i/2||Q>l+i/2||(g(Q),d==null||d(h,Q))};return O(CC,F({className:"StyledNumberInputWrap",style:p,onClick:function(h){return h.stopPropagation()},suffix:c},{children:[B(z5,F({type:r,inputType:"number",value:E,disabled:u,onChange:function(h,Q){Number(h)>l||Number(h)<a||(g(Number(h)),d==null||d(Q,Number(h)))},showClear:!1,style:{paddingRight:"32px"}},C)),O("div",F({className:"land-numberInput-arrow",style:{borderLeft:r==="border"?"1px solid var(--color-border-2)":"",background:"inherit"}},{children:[B("div",F({className:"land-numberInput-add ".concat(E===l?"disabled":""),onClick:function(h){return f==null?void 0:f(h,Number(E)+i)}},{children:B(xA,{name:"arrow"})})),r==="border"&&B(j5,{margin:0,lang:"32px"}),B("div",F({className:"land-numberInput-dec ".concat(E===a?"disabled":""),onClick:function(h){return f==null?void 0:f(h,Number(E)-i)}},{children:B(xA,{name:"arrow"})}))]}))]}))},CC=N.div(sf||(sf=R([`
  position: relative;
  input{
...
`]))),hf,wC=function(A){var e=A.data,t=A.placeholder,r=t===void 0?"请选择":t,n=A.selected,i=n===void 0?"0":n,o=A.width,a=o===void 0?"100px":o,s=A.title,l=A.titleInfo,c=A.info,u=A.disabled,d=A.onChange,p=A.className,C=p===void 0?"":p,v=A.style,E=ce(k.useState(!1),2),g=E[0],f=E[1],h=ce(k.useState(i),2),Q=h[0],U=h[1];return O(mC,F({style:F({width:typeof a=="number"?"".concat(a,"px"):a},v),className:C},{children:[s&&B(re,{title:s,type:"p",info:l}),O(QC,F({className:"hover-pop ".concat(g?"show":""," ").concat(u?"disabled":""),onClick:function(w){u||(w.stopPropagation(),f(!g))}},{children:[B("p",F({className:"".concat(Q!=="0"?"land-select-trigger":"land-select-placeholder")},{children:Q==="0"?r:e==null?void 0:e.filter(function(w){return w.value===Q})[0].label})),B(xA,{name:"arrow",className:"land-select-value-arrow"}),c&&B(wt,{content:c,theme:"dark"})]})),B(yC,F({className:"land-select-results ".concat(g?"show":"")},{children:B(FC,{children:e==null?void 0:e.map(function(w){return O(UC,F({className:"".concat(w.tip?"hover-pop":""," ").concat(Q===w.value?"selected":""," ").concat(w.disabled?"disabled":""),onClick:function(){w.disabled||(U(w.value),d==null||d(w),f(!1))}},{children:[B("div",F({className:"land-select-results-item-label"},{children:w.label})),w.info&&O("div",F({className:"land-select-item-info ".concat(w.info?"hover-pop":"")},{children:[B(xA,{name:"info-stroke",size:12}),w.info&&B(wt,{content:w.info,placement:"right",theme:"dark",style:{marginLeft:"12px"}})]})),w.tip&&B(wt,{content:w.tip,placement:"right",theme:"dark",style:{marginLeft:"8px"}})]}),w.value)})})}))]}))},mC=N.div(Bf||(Bf=R([`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`])));var bf,xC=function(A){var e=A.checked,t=A.label,r=A.checkedLabel,n=A.icon,i=A.checkedIcon,o=A.info,a=A.popProps,s=A.onChange,l=A.style,c=A.className,u=c===void 0?"":c,d=ce(k.useState(e),2),p=d[0],C=d[1];return k.useEffect(function(){return C(e)},[e]),O(YA,F({gap:8,align:"center"},{children:[O(EC,F({className:"land-switch-wrap ".concat(p?"checked":""," ").concat(u),style:l,onClick:function(){C(!p),s==null||s(p)}},{children:[B("div",F({className:"land-switch-bar"},{children:B("div",F({className:"land-switch-indicator"},{children:p?i:n}))})),(t||r)&&B("div",F({className:"land-switch-label"},{children:p?r:t}))]})),o&&O("div",F({className:"land-switch-label-info hover-pop"},{children:[B(xA,{name:"info-stroke",size:16}),B(wt,F({content:o},a))]}))]}))},EC=N.div(If||(If=R([`
  display: flex;
  align-items: center;
  gap: var(--gap-8);
  cursor: pointer;
...
`])));var Sf,G5=function(A){var e=A.desc,t=A.fileType,r=A.onUpload,n=A.children,i=A.width,o=i===void 0?"100%":i,a=A.height,s=a===void 0?"100%":a,l=A.style,c=A.className,u=c===void 0?"":c,d=A.innerClassName,p=d===void 0?"":d,C=k.useRef(null),v=ce(k.useState(),2),E=v[0],g=v[1],f=ce(k.useState(),2),h=f[0],Q=f[1],U=ce(k.useState(!1),2),w=U[0],y=U[1],x=function(W,Z){if(W.preventDefault(),y(!0),Z){Q(Z);var q=new FileReader;q.readAsDataURL(Z),g(URL.createObjectURL(Z)),y(!1)}};k.useEffect(function(){r==null||r(E,h)},[E]);var L=ce(k.useState(!1),2),I=L[0],G=L[1];return O(HC,F({className:"".concat(I?"drag":""," ").concat(u),style:l,onDragOver:function(W){G(!0),W.preventDefault()},onDrop:function(W){return x(W,W.dataTransfer.files[0])},onDragLeave:function(){return G(!1)},width:o,height:s},{children:[B(LC,{ref:C,type:"file",accept:t,className:p,onChange:function(W){x(W,W.target.files[0])}}),n||(w?B(Ri,{children:"上传中"}):O(Ri,{children:[B("div",F({className:"land-uploader-icon"},{children:B(xA,{name:"upload"})})),(e||I)&&B("div",F({className:"land-uploader-desc"},{children:I?"释放即可上传":e}))]}))]}))},HC=N.label(Mf||(Mf=R([`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,I1=({url:A,className:e,imgClassName:t,imgStyle:r,style:n,ratio:i=1/1})=>{const o=k.useRef(null),[a,s]=k.useState(!0),[l,c]=k.useState(!1),u=()=>{setTimeout(()=>{s(!1)},300)},d=()=>{s(!1),c(!0)};return k.useEffect(()=>{const p=o.current;if(p)return p.complete&&s(!1),p==null||p.addEventListener("load",u),p==null||p.addEventListener("error",d),()=>{p==null||p.removeEventListener("load",u),p==null||p.removeEventListener("error",d)}},[]),m.jsxs("div",{className:`relative flex items-center justify-center ${a||l?"bg-gray radius-6 overflow-hidden":""} ${e}`,style:{aspectRatio:a||l?`${i}`:"auto",...n},children:[a&&m.jsx(P5,{color:"var(--color-text-4)",size:28,style:{position:"absolute",transform:"translate(-50%,-50%)"}}),l?m.jsx(xA,{name:"error-fill",fill:"var(--color-red-03)"}):m.jsx("img",{src:A,alt:"",className:t,style:{zIndex:"1",...r}})]})},S1=({data:A=[]})=>{var s,l;const[e,t]=k.useState(!0),[r,n]=k.useState(!1),[i,o]=k.useState(1),a=k.useMemo(()=>A==null?void 0:A.filter(c=>c.id===i)[0],[i,A]);return k.useEffect(()=>{const c=new ResizeObserver(u=>{for(let d of u)d.contentRect.width<=800?n(!0):n(!1)});return c.observe(document.body),()=>{c.disconnect()}},[]),m.jsxs(Ao,{className:"flex-1 flex width-100",children:[m.jsxs(Bp,{className:`relative ${e?"open":""}`,children:[m.jsx("div",{className:"height-100 width-100 overflow-auto pb-24",children:m.jsx("div",{className:"flex column gap-12 px-12 py-24 height-100 width-100",children:A==null?void 0:A.map((c,u)=>m.jsxs("div",{className:"flex column items-center justify-center gap-8 py-12 w-fit-content bg-gray radius-12 cursor-pointer",style:{aspectRatio:1,flexShrink:0},onClick:()=>o(c.id),children:[m.jsx(I1,{url:c.img,className:"radius-8 overflow-hidden",imgStyle:{width:"64px"}}),m.jsx("div",{className:"fs-14 color-gray-3",children:c.title})]},c.id??u))})}),r&&m.jsx("div",{className:"toggle-arrow absolute flex items-center jusity-center border",onClick:()=>t(!e),children:m.jsx(xA,{name:"arrow",className:`${e?"rotate-90":"-rotate-90"}`})})]}),m.jsx("div",{className:"p-24 flex-1  height-100 overflow-auto scrollbar-none shrink-0",children:m.jsxs(YA,{column:!0,gap:16,w:"fit-content",style:{maxWidth:"400px",margin:"0 auto"},children:[m.jsx(re,{title:a.title,type:"h2"}),m.jsxs(YA,{gap:12,className:"p-12 bg-gray radius-8",w:"100%",children:[a.img&&m.jsx(I1,{url:a.img,imgStyle:{width:"100%"},className:"width-50 radius-8 shrink-0"}),a.desc&&m.jsx("div",{className:"fs-12 color-gray-3",children:a.desc})]}),a.detail&&m.jsx("img",{src:a.detail,width:"100%"}),((s=a.detailList)==null?void 0:s.length)>0&&m.jsx("div",{className:"flex column gap-12",children:(l=a.detailList)==null?void 0:l.map(c=>m.jsxs(YA,{column:!0,gap:8,children:[c.desc&&m.jsx(re,{title:c.desc,type:"p"}),c.img&&m.jsx(I1,{url:c.img,imgStyle:{width:"100%"},className:"width-100 radius-8 overflow-hidden"})]}))})]})})]})};/*!
...
`,Oy="https://ingenueland.online/crochet-time/images/colorcard_default.jpeg",$o=[{id:"1",value:"#b9a78f"},{id:"2",value:"#7e6d5b"},{id:"3",value:"#e5e6eb"},{id:"4",value:"#473f3c"},{id:"5",value:"#623726"},{id:"6",value:"#cab8ba"}],Ry=({})=>{const[A,e]=k.useState(""),t=k.useRef(null),r=k.useRef(null),[n,i]=k.useState(2),[o,a]=k.useState([]),[s,l]=k.useState({w:200,h:200,ratio:1});k.useEffect(()=>{if(!t.current)return;const D=new Image;D.onload=function(){var K=this.width,H=this.height;l({w:K,h:H,ratio:K/H})},D.src=A},[A,t]),k.useEffect(()=>{if(!r.current)return;const D=new ResizeObserver(K=>{for(const H of K)i(H.contentRect.width/H.contentRect.height)});return D.observe(r.current),console.log("设置了图片wrap尺寸"),()=>D.disconnect()},[r,A]);const c=()=>{if(o.length>=0)if(o.length<8){let D="";window.EyeDropper||E(!0,"你的浏览器不支持此功能"),new EyeDropper().open().then(H=>{D=H.sRGBHex,a([...o,{id:`${D}`,value:D}])}).catch(()=>{E(!0,"出错了～")})}else E(!0,"已达上限～长按删除后重试");else E(!0,"请先上传图片～")},u=D=>{const K=o.filter(H=>H.id!==D);a(K)},[d,p]=k.useState(!1),[C,v]=k.useState(""),E=(D,K)=>{v(K),p(D);const H=setTimeout(()=>{p(!1),clearTimeout(H)},1e3)},g=D=>{const K=P(`rgb(${D[0]},${D[1]},${D[2]})`).toHsv();return K.s<=x/100||K.v<=x/100};function f(D,K,H=32){if(g(D))return!0;const S=D[0]-K[0],M=D[1]-K[1],j=D[2]-K[2];return Math.sqrt(S*S+M*M+j*j)<H}const h=D=>{const K=document.createElement("canvas"),H=K.getContext("2d");return K.width=D.width,K.height=D.height,H==null||H.drawImage(D,0,0,D.width,D.height),H==null?void 0:H.getImageData(0,0,D.width,D.height).data},Q=D=>{const K=h(D);if(!K)return;const H=new Map;for(let j=0;j<K.length;j+=4){const lA=[K[j],K[j+1],K[j+2]].join(",");H.has(lA)?H.set(lA,H.get(lA)+1):H.set(lA,1)}let S=Array.from(H.entries()).sort((j,z)=>z[1]-j[1]).map(j=>j[0].split(",").map(z=>parseInt(z)));const M=[];for(const j of S)if(!M.some(z=>f(j,z,32))&&!g(j)&&M.push(j),M.length>=W)break;return M},[U,w]=k.useState(!1),y=D=>{const K=new Image;K.src=D,K.onload=()=>{var S;const H=((S=Q(K))==null?void 0:S.map(M=>({id:M[0]+M[1]+M[2],value:`#${P(`rgb(${M[0]},${M[1]},${M[2]})`).toHex()}`})))??[];a(H),w(!1)}},[x,L]=k.useState(10),[I,G]=k.useState(!0);k.useEffect(()=>{x>0?G(!0):G(!1)},[x]),k.useEffect(()=>{L(I?x||10:0)},[I]);const[W,Z]=k.useState(6);k.useEffect(()=>{y(A)},[x,I,W]);const[q,GA]=k.useState(["","","","","",""]);return m.jsxs(Ao,{className:"flex-1 flex column items-start gap-32 pt-32 px-24 pb-24 width-100",children:[m.jsxs(YA,{column:!0,gap:24,children:[m.jsx(Sc,{mainTitle:"Step 01: 上传文件",subTitle:"点击或拖拽来上传图片，以像素为单位对颜色计数"}),m.jsx("div",{className:"width-100",style:{height:"240px"},children:m.jsx(G5,{fileType:"image/*",onUpload:D=>{e(D),a([])},desc:"点击上传图片或将图片拖拽于此",className:"radius-12",children:A&&m.jsx("div",{ref:r,className:"flex items-center justify-center width-100 height-100",children:m.jsx("img",{ref:t,src:A,className:`radius-8 ${s.ratio<n?"height-100":"width-100"}`})})})})]}),m.jsxs("div",{className:"flex column width-100",children:[m.jsxs("div",{className:"width-100 flex column",children:[m.jsx(re,{title:"Step 02: 取色配置",type:"h3"}),m.jsx(re,{title:m.jsxs(m.Fragment,{children:["【过滤颜色】设置过滤中性色的范围",m.jsx("br",{}),"【提取数量】可一次提取6、8、10个颜色",m.jsx("br",{}),"【编辑颜色】支持删除、添加、修改提取的颜色列表"]}),type:"p",className:"color-gray-4 mt-8"}),(o==null?void 0:o.length)!==0&&m.jsxs("div",{className:"flex gap-24 mt-12",children:[m.jsxs("div",{className:"flex column gap-8",style:{width:"124px"},children:[m.jsx(AC,{text:"过滤中性色",checked:I,onChange:()=>{G(!I)},pop:"勾选后将自动过滤饱和度或纯度低于 10 的颜色<br/>支持输入自定义过滤范围（≤35）"}),m.jsx(ec,{max:35,min:0,step:5,value:x,onChange:D=>L(Number(D))})]}),m.jsx(wC,{title:"数量",width:124,data:[{value:"1",label:"4"},{value:"2",label:"6"},{value:"3",label:"8"}],selected:"2",onChange:D=>{Z(Number(D.label))}})]})]}),m.jsxs("div",{className:"relative flex items-center justify-center flex-wrap gap-12 p-24 flex-1",style:{minWidth:"325px"},children:[o.length===0&&A&&m.jsx("div",{className:"absolute",style:{zIndex:1},children:U?m.jsx(P5,{}):m.jsx(cn,{text:"提取颜色",type:"background",status:"primary",onClick:()=>{y(A),w(!0)}})}),o.length===0?$o==null?void 0:$o.map((D,K)=>m.jsxs(t4,{className:"flex column items-center relative justify-center gap-4 disabled",children:[m.jsx(Nd,{value:D.value,size:36,border:!0}),m.jsx("div",{className:"fs-10 color-gray-4",children:D.value})]},K)):o==null?void 0:o.map((D,K)=>m.jsx(Ny,{onClick:()=>u(D.id),children:m.jsxs(t4,{className:"flex column items-center relative justify-center gap-4",children:[m.jsx(Nd,{value:D.value,size:36,border:!0,onChange:H=>{const S=o.map(M=>({id:M.id,value:M.id==D.id?`#${P(H).toHex()}`:M.value}));a(S)}}),m.jsx("div",{className:"fs-10 color-gray-4",children:D.value})]},K)},K)),o.length!==0&&o.length<8&&m.jsxs(jy,{className:"StyleAddColorBtn relative flex both-center border radius-50 cursor-pointer hover-pop",onClick:()=>c(),children:[m.jsx(TC,{}),m.jsx(wt,{content:"点击吸取颜色",theme:"dark"})]})]})]}),m.jsxs(YA,{column:!0,gap:8,children:[m.jsx(re,{title:"Step 03: 下载 & 保存色卡",type:"h3"}),m.jsx(re,{title:"调整颜色至满意值后，点击下载色卡，即可保存到本地",type:"p",className:"color-gray-4"})]}),(o==null?void 0:o.length)===0?m.jsx(r4,{className:"grid mx-32 gap-24 pb-24 disabled",length:6,children:Array.from({length:6}).map((D,K)=>m.jsxs("div",{className:"flex column items-center gap-12",children:[m.jsxs(n4,{className:`StyleColorCardBox relative p-24 flex gap-4 width-100 border color-card card-${K} column`,width:s.w,height:s.h,ratio:s.ratio,children:[m.jsx("div",{className:"color-img",children:m.jsx("img",{src:Oy})}),m.jsx("div",{className:"color-list grid gap-4",children:(o==null?void 0:o.length)===0?$o.map(H=>m.jsxs("div",{className:"color-item flex column items-center gap-4",children:[m.jsx("div",{style:{background:H.value},className:"width-100 flex-1"}),m.jsx("p",{children:H.value})]},H.id)):o.map(H=>m.jsxs("div",{className:"color-item flex column items-center gap-4",children:[m.jsx("div",{style:{background:H.value},className:"width-100 flex-1"}),m.jsx("p",{children:H.value})]},H.id))})]}),m.jsx(cn,{type:"background",className:"width-100",text:"下载色卡",icon:m.jsx(xA,{name:"download"})})]},K))}):m.jsx(r4,{className:"grid mx-32 gap-24 pb-24",length:o.length,children:Array.from({length:6}).map((D,K)=>m.jsxs("div",{className:"flex column items-center gap-12",children:[m.jsxs(n4,{className:`relative p-24 flex gap-4 width-100 border color-card card-${K} ${s.ratio<1?"":"column"}`,width:s.w,height:s.h,ratio:s.ratio,children:[m.jsx("div",{className:"color-img",children:m.jsx("img",{src:A})}),m.jsx("div",{className:"color-list grid gap-4",children:o.map(H=>m.jsxs("div",{className:"color-item flex column items-center gap-4",children:[m.jsx("div",{style:{background:H.value},className:"width-100 flex-1"}),m.jsx("p",{children:H.value})]},H.id))})]}),m.jsxs("div",{className:"width-100 flex gap-12",children:[m.jsx(z5,{placeholder:"自定义色卡名称",value:q[K],onChange:H=>{const S=q.map((M,j)=>j===K?String(H):M);GA(S)},className:"flex-1"}),m.jsx(cn,{type:"background",className:"flex-1",text:"下载色卡",icon:m.jsx(xA,{name:"download"}),onClick:()=>{const H=document.querySelectorAll(".color-card");Wu(H[K],q[K],4)}})]})]},K))}),m.jsx(hC,{show:d,text:C})]})},t4=Te.div`
  width: 48px;
  &.disabled {
...
`,Py=({})=>{const A=k.useRef(null),[e,t]=k.useState(""),[r,n]=k.useState(12),[i,o]=k.useState(12),[a,s]=k.useState(16),l=k.useMemo(()=>Array.from({length:r}).map((x,L)=>Array.from({length:i}).map((I,G)=>({key:`${L}-${G}`,value:"transparent"}))),[r,i]),[c,u]=k.useState(l);k.useEffect(()=>{const x=Array.from({length:r}).map((L,I)=>Array.from({length:i}).map((G,W)=>({key:`${I}-${W}`,value:c[I]&&c[I][W]?c[I][W].value:"transparent"})));u(x)},[r,i]);const[d,p]=k.useState(""),C=k.useRef(null),v=k.useRef(null),[E,g]=k.useState(2),[f,h]=k.useState({w:200,h:200,ratio:1});k.useEffect(()=>{if(!C.current)return;const x=C.current.getBoundingClientRect();h({w:x.width,h:x.height,ratio:x.width/x.height})},[d,C]),k.useEffect(()=>{if(!v.current)return;const x=new ResizeObserver(L=>{for(const I of L)g(I.contentRect.width/I.contentRect.height)});return x.observe(v.current),()=>x.disconnect()});const[Q,U]=k.useState(""),[w,y]=k.useState(!1);return m.jsxs(zy,{className:"flex-1 flex column items-start gap-32 py-24 px-16 width-100 height-100 scrollbar-none",children:[m.jsxs("div",{className:"flex gap-12 width-100 justify-end",children:[m.jsx("div",{style:{width:"20px",height:"20px"},onClick:()=>{if(a>12){let x=a-4;s(x)}},children:m.jsx(NC,{fill:"#999",size:20})}),m.jsx("div",{style:{width:"20px",height:"20px"},onClick:()=>{if(a<32){let x=a+4;s(x)}},children:m.jsx(xA,{name:"add",stroke:"#999",strokeWidth:2,size:20})})]}),m.jsx("div",{className:"scrollbar-none",style:{width:"calc(100vw - 32px - 20px)",maxHeight:"calc(100vh - 64px - 48px - 76px - 140px - 37px - 72px - 26px)",minHeight:"192px",maxWidth:"800px",margin:"0 auto",overflow:"auto"},children:m.jsx("div",{ref:A,className:"flex flex-wrap",style:{width:`${r*a}px`,height:`${i*a}px`,margin:"auto",background:d&&w?`url(${d}) center center/contain no-repeat`:"unset"},children:Array.from({length:r}).map((x,L)=>m.jsx("div",{className:"flex column",style:{flexDirection:"column-reverse"},children:Array.from({length:i}).map((I,G)=>m.jsx(Gy,{className:`relative transition ${e===`${L}-${G}`?"active":""} ${L===0?"first-column":""} ${G===0?"last-row":""}`,style:{width:`${a}px`,height:`${a}px`,backgroundColor:c[L]&&c[L][G]?c[L][G].value:"transparent"},onClick:()=>{t(`${L}-${G}`);const W=c.map(Z=>Z.map(q=>q.key===`${L}-${G}`?{key:q.key,value:Q}:q));u(W)}},G))},L))})}),m.jsx(mh,{className:"flex items-center justify-center fs-12 color-gray-2 width-100 border radius-6 shrink-0",style:{background:Q},children:m.jsx("input",{type:"color",onChange:x=>U==null?void 0:U(x.target.value)})}),m.jsxs(YA,{column:!0,gap:8,children:[m.jsx(Sc,{mainTitle:"设置画布大小",mainInfo:"画布大小范围为 4x4 - 48x48"}),m.jsxs(YA,{gap:16,bothCenter:!0,children:[m.jsx(re,{title:"宽:",type:"p"}),m.jsx(ec,{value:r,onChange:(x,L)=>L>=4&&L<=48&&n(L)}),m.jsx(re,{title:"高:",type:"p"}),m.jsx(ec,{value:i,onChange:(x,L)=>L>=4&&L<=48&&o(L)})]})]}),m.jsxs(YA,{column:!0,gap:8,children:[m.jsx(Sc,{mainTitle:"导入参考图"}),m.jsx(xC,{checked:w,onChange:()=>y(!w)}),m.jsx(YA,{gap:16,bothCenter:!0,className:"overflow-hidden",style:{height:w?"100px":"0px"},children:m.jsx(G5,{fileType:"image/*",height:"100px",onUpload:x=>p(x),desc:"点击上传图片或将图片拖拽于此",className:"radius-12",width:"100%",children:d&&m.jsx("div",{ref:v,className:"flex items-center justify-center width-100 height-100",children:m.jsx("img",{ref:C,src:d,className:`radius-8 ${f.ratio<E?"height-100":"width-100"}`})})})})]}),m.jsxs(YA,{justify:"center",gap:12,children:[m.jsx(cn,{text:"清空画布",onClick:()=>u(l)}),m.jsx(cn,{text:"立即下载",type:"background",className:"flex-1",style:{maxWidth:"200px"},onClick:()=>{Wu(A.current,"pixel-res",1)}})]})]})},zy=Te(Ao)`
  @media screen and (max-width: 800px) {
    .land-uploader-desc {
      font-size: 12px;
    }
...
`;function Zy(){const[A,e]=k.useState(1),[t,r]=k.useState(1),[n,i]=k.useState(E1);return k.useEffect(()=>{(document.querySelector("#root")||document.body).getBoundingClientRect().width>800?i(E1.map(s=>({key:s.key,title:s.title,dropData:s.dropData,open:!1}))):i(E1)},[]),m.jsxs(YA,{column:!0,className:"height-100",children:[m.jsx(Wy,{logo:m.jsx(_C,{}),menuProps:{data:n,active:A,onChange:o=>{r(o.key),e(o.key)},onDropChange:(o,a)=>{r(o.key),e(a.key)},dropProps:{direction:"column",active:t},theme:{lineColor:"inherit",activeBg:"var(--color-bg-2)"}},align:"end",className:"relative"}),t===1&&m.jsx(Xf,{data:kC}),t===2&&m.jsx(Xf,{data:bC}),t===11&&m.jsx(S1,{data:IC}),t===12&&m.jsx(S1,{data:SC}),t===21&&m.jsx(Ry,{}),t===22&&m.jsx(fy,{pathData:DC}),t===23&&m.jsx(Py,{}),t===31&&m.jsx(S1,{data:MC})]})}const Wy=Te(uC)`
  /* &.kjXciE {
    z-index: 100;
  }
  @media screen and (max-width: 800px) {
...
`;el.createRoot(document.getElementById("root")).render(m.jsx(Se.StrictMode,{children:m.jsx(Zy,{})}));
