...
export const XC_List_Data = [
    {
        ...
        img: "https://s2.loli.net/2022/01/25/oF9sdLS84a1VAhN.png",
        detailList: [
            {
            ...
            },
            {
                ...
                img: "https://s2.loli.net/2022/01/25/ASE5wxC9UpZFivR.png"
            },
            {
                desc: "3、线材的常见缠线方式：线球、团、绞、束、筒",
                img: "https://s2.loli.net/2022/01/25/YRVmGirHJCNtjoA.png"
            },
            {
                desc: "4、手缠线方法：市场上常见的编织线都是成卷的，但是也存在需要自己绕线成卷的情况。如果没有绕线机，可参考图示手缠线的方法整理散线。",
                img: "https://s2.loli.net/2022/01/25/4MGbrpEeZcvRJio.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/EPBGVcaHt8hqUmM.png",
        detailList: [
            {
                desc: "\n1、纯棉线：未经处理的纯棉非常适合手工染色。",
                img: "https://s2.loli.net/2022/01/25/HCFbUrJ4fghsDlW.png"
            },
            {
                ...
                img: "https://s2.loli.net/2022/01/25/Ah48aHczMqDwRTk.png"
            },
            {
                desc: "【4股牛奶棉】常用于编织玩偶，搭配2-3mm钩针、2.5-3mm棒针",
                img: "https://s2.loli.net/2022/01/25/ltX94d7Yw6UeK1g.png"
            },
            {
                desc: "【5股牛奶棉】常用于玩偶、衣物、毯子等，搭配3-4mm钩针、4-4.5mm棒针",
                img: "https://s2.loli.net/2022/01/25/LpBWFTE7esUXuAr.png"
            },
            {
                desc: "【8股牛奶棉】常用于围巾、衣物，搭配5-5.5mm棒针",
                img: "https://s2.loli.net/2022/01/25/cX8p7ZmlKP52nxs.png"
            },
            {
                desc: "3、丝光棉：棉纱可以进行丝光处理，在此过程中，它经过机械和化学处理以压缩它，将其转变为具有反光光泽且不会掉毛的超强纱线。丝光棉通常是更昂贵的选择，但它非常适合需要坚固和保持形状的，例如闪亮的晚装包、长款夏季开衫或需要定期洗涤的外套。",
                img: "https://s2.loli.net/2022/01/25/A9dYxhferw3DJGa.png"
            },
            {
                ...
                img: "https://s2.loli.net/2022/01/25/L5CwJSm2IdGNDea.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/wMc8y4HODFXRskN.png",
        detailList: [
            {
                desc: "\n1、美利奴羊毛：这种特殊的羊毛来自美利奴绵羊，拥有绵羊品种中最好的羊毛之一。 长而有光泽的纤维产生柔软的纱线，是贴身穿着的物品的绝佳选择。 它通常与其他纤维混合，并经常进行处理以使其可机洗。",
                img: "https://s2.loli.net/2022/01/25/vpoaYSKZEr967jA.png"
            },
            {
                desc: "2、设得兰羊毛：也称雪莱毛。设得兰是英国绵羊品种中最小的，主要分布在英国苏格兰的设得兰群岛。",
                img: "https://s2.loli.net/2022/01/25/GPFTHXKj5khvA1d.png"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/YxRkGDKtuXlIOTJ.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/kV296XjuStdIe3n.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/MXzrAR3xiCJaPw1.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/ZMlI7fqNCAWBU9V.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/NErtZw4DliGpWHo.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/8uwmpJxZSYhtcjC.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/E2qRwWNcdMGBkvu.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/eQ8FDaYmlPf9qSc.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/gjPC1Usb3rxn6N8.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/BnoFlr4f3yqmDsb.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/w1pyflIxKYSoCVH.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/8RqUzuyZCt2JXi1.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/mgupIwTP72sRkqy.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/GlBsSFoAcNwmkWz.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/fpM5VBvQU4I7uL6.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/UPrC8AamKbSDgGq.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/VH4awB8RS1AxEft.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/7OQBSmdIjl28yY4.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/BjPRKr14yeVnhum.png",
        detailList: [
            {
                desc: "\n1、扁带线：扁带线的主要特征是其扁平的轮廓。",
                img: "https://s2.loli.net/2022/01/25/VZBlsueOMhNdGKk.png"
            },
            {
                desc: "2、缎带纱：带状纱的形状类似于带状纱，但通常更宽一些。 丝带纱线特别适合制作漂亮的配饰。",
                img: "https://s2.loli.net/2022/01/25/ukXfrDbEjRq2Cyp.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/akO7DeQG4Y5t62M.png",
        detailList: [
            {
                desc: "\n布条线的花纹或图案由织物条而定：",
                img: "https://s2.loli.net/2022/01/25/SZDzcYBofOhyGt7.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/vj2qVMbyZdXeHpn.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/L1yjxqOVrF7zp9a.png"
            }
        ]
    },
    {
        ...
        title: "反光纱",
        desc: "弹力纱含有少量弹性弹性纤维，可增强所得织物的自然回弹。 主要纤维可以是天然的（例如棉），也可以是混纺的或全合成的。弹力纱是夏季沙滩装和运动装的理想选择。",
        img: "https://s2.loli.net/2022/01/25/A81VjgNMauqviI4.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/nBMP4KhsVueqAvi.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/CuHs3QLcWgb9Ezw.png",
        detailList: [
            {
                desc: "\n蕾丝线号数：通常号数越大线越细。常用的蕾丝线主要有3#、8#、80#等。",
                img: "https://s2.loli.net/2022/01/25/nZNwy95vVjaoeRq.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/RpQBurSPcVjif5w.png",
        detailList: [
            {
                img: "https://s2.loli.net/2022/01/25/2H3nJBb4s6mjKaX.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/BfRQaqjEVbeiPWL.png",
        detailList: [
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/BDZyPaLpherEK36.png",
        detailList: [
            {
                desc: "\n1、珊瑚绒",
                img: "https://s2.loli.net/2022/01/25/JqScLpIDUrAxEv2.png"
            },
            {
                desc: "2、皮草绒",
                img: "https://s2.loli.net/2022/01/25/VJkTpNIM6f8zoCg.png"
            },
            {
                desc: "3、长毛水貂绒",
                img: "https://s2.loli.net/2022/01/25/AdXnqzy9jtoV5S8.png"
            },
            {
                desc: "长绒线织物示例：",
                img: "https://s2.loli.net/2022/01/25/IqHVlJ2OaSBMAg3.png"
            }
        ]
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/L1bZIx37WmCahMz.png",
        detailList: [
            {
                desc: "\n织物示例：",
                img: "https://s2.loli.net/2022/01/25/OHRYepUQls6uvoc.png"
            },
            {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/uARKnrW3oJlfPjz.png",
        detailList: [
            {
                desc: "\n1、合股线：一方面，大多数用于手编的纱线都是合股的，可以增加稳定性和厚度；另一方面，将几种颜色混合在一起形成的合股纱线会产生不同的纹理。",
                img: "https://s2.loli.net/2022/01/25/w5Hu2cv4zSDbVlQ.png"
            },
            {
                desc: "2、混合线：通过将混线的方式编织可以得到很多各具特色的花纹。",
                img: "https://s2.loli.net/2022/01/25/B9oDZIRl73OTW2z.png"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        img: "https://s2.loli.net/2022/01/25/eSq1aXbhLvjYBtK.png",
        detailList: [
            {
                desc: "\n1、塑料线：",
                img: "https://s2.loli.net/2022/01/25/kzVxQyKT9f7mLhN.png"
            },
            {
                desc: "2、塑料绳：",
                img: "https://s2.loli.net/2022/01/25/6ZsPRpYnO2Dfmj5.png"
            },
            {
                desc: "3、胶制线：",
                img: "https://s2.loli.net/2022/01/25/q83USGb6L1plXV2.png"
            },
            {
                desc: "4、金属线：",
                img: "https://s2.loli.net/2022/01/25/9KLmRBQowyjItOS.png"
            }
        ]
    }
]
...
export const TJ_List_Data = [
    {
      ...
      detail: "https://s2.loli.net/2022/01/26/8SvMqzflRhdQyjH.png"
    },
    {
      id: 2,
      title: "粉茶兔",
      ...
      detail: "https://s2.loli.net/2022/01/26/3b2MJiC8gktWNSE.png"
    },
    {
      id: 3,
      title: "灰色长绒兔",
      ...
      detail: "https://s2.loli.net/2022/01/26/R8frKTn5gF9DI1p.png"
    },
    {
      id: 101,
      title: "水蜜桃耳环",
      ...
      detail: "https://s2.loli.net/2022/01/26/8ygiUZJVbsHnwxv.png"
    },
    {
      id: 102,
      title: "水蜜桃挂件",
      ...
      detail: "https://s2.loli.net/2022/01/26/YD2eKB3NcfntlGM.png"
    },
    {
      id: 201,
      title: "白熊眼罩",
      ...
      detail: "https://s2.loli.net/2022/01/26/81dIH7uaVMAzWbD.png"
    },
    {
      id: 202,
      title: "熊猫卡衣",
      ...
      detail: "https://s2.loli.net/2022/01/26/kzrmgGLeC2I7YMb.png"
    }
]
...
export const ColorFill_Path_List_Data = [
    {
        id: 1,
        img:'https://ingenueland.online/crochet-time/images/ct-color-fill-svg-sock-1.jpg',
        path: [
