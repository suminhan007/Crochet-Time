...
const PixelDrawer: React.FC<Props> = ({ isEnglish}) => {
  ...
  return (
      <div className={'fixed top-0 left-0 top-0 left-0 width-100 height-100 bg-white'} style={{zIndex:1023}}>
          <CourseHeader title={'绘制像素图'} isEnglish={isEnglish} backHref={'/type=tools'}/>
          <StyledPixelLandContent
              className="flex items-start gap-32 py-24 px-16 width-100 height-100 scrollbar-none">
